...
<head>
    ...
    <title>Admin Taxi manager</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{URL('server/img/logo-taxi.png')}}">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOrder" class="collapse" aria-labelledby="headingProduct" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="adddriver">Thêm tài xế</a>
                        <a class="collapse-item" href="listdriver">Danh sách tài xế</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseWeb" aria-expanded="true" aria-controls="collapseWeb">
                    ...
                    <span>Quảng cáo video</span>
                </a>
                <div id="collapseWeb" class="collapse" aria-labelledby="headingWeb" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="addvideo">Thêm video</a>
                        <a class="collapse-item" href="listvideo">Danh sách video</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMember" class="collapse" aria-labelledby="headingMember" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="addinsurance">Thêm bảo hiểm</a>
                        <a class="collapse-item" href="listinsurance">Danh sách bảo hiểm</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCategories" class="collapse" aria-labelledby="headingCategories" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="addlicense">Thêm giấy phép</a>
                        <a class="collapse-item" href="listlicense">Danh sách giấy phép</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseProduct" class="collapse" aria-labelledby="headingProduct" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="addreport">Thêm báo cáo</a>
                        <a class="collapse-item" href="listreport">Danh sách báo cáo</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <i class="far fa-envelope"></i>
                    <span>Nhà sản xuất taxi </span>
                </a>
                <div id="collapseMessage" class="collapse" aria-labelledby="headingProduct" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="addvehiclemanufacture">Thêm hãng xe taxi</a>
                        <a class="collapse-item" href="listvehiclemanufacture">Danh sách các hãng xe taxi</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseParagraph" class="collapse" aria-labelledby="headingPost" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="addtaxi">Thêm xe taxi </a>
                        <a class="collapse-item" href="listtaxi">Danh sách xe taxi </a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Designer by Thanh Tuấn & Hoàng Việt
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-success" href="/">Đăng xuất</a>
